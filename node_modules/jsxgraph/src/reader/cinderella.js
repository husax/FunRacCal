    ...
    JXG.extend(JXG.CinderellaReader.prototype, /** @lends JXG.CinderellaReader.prototype */ {
        read: function () {
            ...
            for (i = 0; i < dataLines.length; i++) {
                ...
                // line or segment
                } else if (dataLines[i].search(/Join\(.+/) !== -1 || dataLines[i].search(/Segment\(.+/) !== -1) {
                ...
                } else if (dataLines[i].search(/CircleByFixedRadius.+/) !== -1 || dataLines[i].search(/CircleByRadius.+/) !== -1) {
                ...
                // glider on a line
                    ...
                    pCoords = pCoords.split(',');
                    pCoords[0] = parseFloat(pCoords[0].slice(1, pCoords[0].search(/\+i\*/)));

                    for (j = 1; j < pCoords.length; j++) {
                        pCoords[j] = parseFloat(pCoords[j].slice(0, pCoords[j].search(/\+i\*/)));
                    }
                ...
                } else if (dataLines[i].search(/ConicFoci\(.+/) !== -1 || dataLines[i].search(/ConicFociH\(.+/) !== -1) {
                    defPoints = dataLines[i].split(':=');
